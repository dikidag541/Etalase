...
export default function CinematicHero({
    ...
    return (
        <section
            ...
            className="relative w-full h-screen bg-[#050505] overflow-hidden flex items-center justify-center cursor-default z-0"
        >
            ...
            >
                <span className="text-white/40 text-[8px] tracking-[1em] uppercase font-black vertical-text">DISCOVER</span>
                <div className="w-[1px] h-24 bg-gradient-to-b from-gold-500/50 to-transparent"></div>
            </motion.div>

            {/* ATMOSPHERIC ENVIRONMENTAL LIGHTING */}
            <div className="absolute top-0 left-0 w-full h-[25vh] bg-gradient-to-b from-black to-transparent z-40 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-full h-[35vh] bg-gradient-to-t from-black via-black/80 to-transparent z-40 pointer-events-none" />
