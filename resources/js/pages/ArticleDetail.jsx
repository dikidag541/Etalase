        ...
        <MainLayout>
            ...
            <article className="bg-surface transition-colors duration-500">
                    ...
                    <div className="absolute bottom-0 left-0 w-full py-20">
                        <div className="max-w-4xl mx-auto px-4">
                            ...
                            <div className="flex items-center gap-6 mb-6">
                                ...
                                <span className="text-text-muted text-[10px] uppercase tracking-widest">{new Date(article.created_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-gold-500 overflow-hidden border border-border-main">
                                    <div className="w-full h-full bg-surface flex items-center justify-center text-gold-500 font-serif text-xl border border-border-main">
                                        {(article.author || 'E')[0]}
                                    </div>
                                </div>
                                <div>
                ...
                <div className="py-24 bg-surface transition-colors duration-500">
                    <div className="max-w-4xl mx-auto px-4">
                        <div className="editorial-content font-sans text-lg text-text-muted font-light leading-relaxed space-y-12 whitespace-pre-wrap">
                            {article.content}
                        </div>
                        ...
                        <div className="mt-20 pt-10 border-t border-border-main flex flex-wrap justify-between items-center gap-8">
                            <div className="flex gap-3">
                                {[article.category, 'Seni', 'Budaya', 'Etalase'].map(tag => (
                ...
                <section className="py-20 bg-surface border-y border-border-main transition-colors duration-500">
                    <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
                        <div className="w-32 h-32 bg-gold-400 shrink-0 border border-border-main">
                            <div className="w-full h-full bg-surface flex items-center justify-center text-gold-500 font-serif text-5xl border border-border-main">
                                {(article.author || 'E')[0]}
                            </div>
                        </div>
                        <div>
