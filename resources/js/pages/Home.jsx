...
export default function Home({ cms = {}, divisions = [] }) {
    ...
    useEffect(() => {
        ...
        document
            .querySelectorAll(".reveal, .curtain-reveal, .parade-item")
        ...
        <MainLayout>
            ...
            <section className="relative min-h-[120vh] bg-surface z-[10]">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    >
                        <source
                            src={cms.hero_video || "/videos/Trailer.mp4"}
                            type="video/mp4"
                        />
                    </video>
                ...
                <div className="relative z-10 w-full min-h-screen flex flex-col justify-end items-center pb-[4vh] mt-24">
                    ...
                    >
                        ...
                        {/* Ghost Outline Text */}
                        <span
                            className="absolute top-0 left-0 pl-[5vw] font-playfair italic text-outline text-[18vw] leading-[0.8] tracking-tighter select-none block whitespace-nowrap opacity-30 mix-blend-overlay"
                            style={{
                    ...
                    >
                        ...
                        {/* Ghost Outline Text */}
                        <span
                            className="absolute top-0 right-0 pr-[5vw] font-playfair italic text-outline text-[18vw] leading-[0.8] tracking-tight select-none block whitespace-nowrap opacity-30 mix-blend-overlay"
                            style={{
                    ...
                    <div className="mt-24 flex flex-col items-center gap-12 reveal relative z-20">
                        <CMSText
                            as="p"
                            className="text-white text-[10px] md:text-xs font-bold tracking-[0.6em] uppercase opacity-40 mix-blend-difference"
                        >
                ...
                <div
                    ...
                    style={{
                        transform: `translateX(${-scrollY * 0.1}px) translateY(-50%)`,
                    }}
                >
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-48">
                        <div className="reveal">
                            <div className="flex items-center gap-8 mb-16">
                                ...
                                <span className="text-gold-500 text-sm tracking-[1.5em] uppercase font-black">
                                    {cms.parade_badge || "Dynamic Parade"}
                                </span>
                            </div>
                            ...
                            <h2 className="font-serif text-[14vw] md:text-[8vw] lg:text-[10rem] leading-[0.8] text-text-main italic tracking-tighter mb-8 md:mb-16 select-none">
                                <span className="block mb-6">
                                    {cms.manifesto_title_1 || "The Grand"}
                                </span>
                            ...
                            <div className="flex gap-8 md:gap-16">
                                <div>
                                    <span className="block text-4xl md:text-6xl font-black text-text-main italic">
                                        {cms.parade_stat_1_val || "12+"}
                                    </span>
                                    <CMSText className="text-gold-500/50 text-[10px] uppercase tracking-[0.4em] font-bold">
                                        {cms.parade_stat_1_label || "Fase"}
                                    </CMSText>
                                </div>
                                <div>
                                    <span className="block text-4xl md:text-6xl font-black text-text-main italic">
                                        {cms.parade_stat_2_val || "150+"}
                                    </span>
                                    <CMSText className="text-gold-500/50 text-[10px] uppercase tracking-[0.4em] font-bold">
                                        {cms.parade_stat_2_label || "Kolektif"}
                                    </CMSText>
                                </div>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                src:
                                    cms.parade_image_1 ||
                                    "/images/Salinan Ave 4 cymk.webp",
                                delay: "0",
                                speed: 0.1,
                            },
                            {
            ...
            <section className="relative bg-surface py-24 md:py-48 lg:py-60 flex items-center justify-center z-[30]">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src={
                            cms.masterpiece_image || "/images/hero_carnival.png"
                        }
                ...
                <div className="max-w-[1200px] mx-auto px-6 text-center relative z-10 reveal">
                    ...
                    >
                        "
                        {cms.masterpiece_quote ||
                            "Setiap helai kain adalah doa, setiap gerak adalah revolusi rupa raga."}
                        "
                    </CMSText>
                    <Link
                        href="/about"
                    ...
                    >
                        {t("home_the_essence")}{" "}
                        <ArrowRightIcon className="w-8 h-8 transition-transform group-hover:translate-x-6" />
                    </Link>
                </div>
            </section>
            ...
            <section className="relative bg-surface py-24 md:py-48 lg:py-60 z-[40] overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 text-center mb-48 reveal relative z-10">
                    <span className="text-etalase-red text-sm tracking-[2em] uppercase font-black mb-12 block">
                        {cms.faset_badge || "Faset Kesenian"}
                    </span>
                    <h2 className="text-5xl md:text-7xl lg:text-[10rem] font-serif text-text-main italic leading-none tracking-tighter">
                        {cms.faset_title || "Diverse Expression"}
                    </h2>
                </div>
                            ...
                            : [
                                  {
                                      short_name: "TARI",
                                      image_url:
                                          "/images/dance_performance.png",
                                  },
                                  {
                                      short_name: "TEATER",
                                      image_url: "/images/IMG_5939.JPG",
                                  },
                                  {
                                      short_name: "MUSIK",
                                      image_url: "/images/IMG_5942.JPG",
                                  },
                                  {
                                      short_name: "FOTOGRAFI",
                                      image_url: "/images/IMG_6046.JPG",
                                  },
                                  {
                                      short_name: "PSM",
                                      image_url: "/images/IMG_0266.JPG",
                                  },
                              ]
                        ).map((faset, i) => (
                            <DivisionCard
...
function DivisionCard({ faset, i, scrollY, isDarkMode }) {
    ...
    const layouts = [
        { offset: "mt-0", width: "w-full md:w-7/12", speed: 0.05 },
        {
            ...
            width: "w-full md:w-4/12 ml-auto",
            speed: 0.1,
        },
        { offset: "-mt-12 md:-mt-32", width: "w-full md:w-5/12", speed: 0.03 },
        {
            offset: "mt-12 md:mt-24",
            width: "w-full md:w-6/12 ml-[5%]",
            speed: 0.08,
        },
        {
            offset: "mt-0 md:-mt-64 mr-auto",
            width: "w-full md:w-4/12 ml-[10%]",
            speed: 0.12,
        },
        {
            offset: "mt-24 md:mt-12 ml-auto",
            ...
            >
                ...
                <img
                    src={
                        ...
                        faset.image_path ||
                        faset.img ||
                        "/images/placeholder-division.png"
                    }
                ...
                <div
                    className={`absolute top-8 left-8 text-8xl font-black italic select-none pointer-events-none transition-all duration-700 ${isHovered ? "opacity-30 scale-125 translate-x-6" : "opacity-10 scale-100"} text-gold-500 dark:text-white`}
                >
                    0{i + 1}
                </div>
                ...
                <div
                    ...
                    style={{
                        transform: `translateY(${scrollY * layout.speed}px)`,
                    }}
                >
